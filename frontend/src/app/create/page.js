...
export default function CreateCollection() {
    ...
    return (
        <div className='bg-background font-helvetica min-h-screen w-fill overflow-x-hidden'>
            <br></br>
            <div className="max-w-4xl mx-auto p-6 bg-gray-100 rounded-lg shadow-md">
                ...
                {uuid && (
                    <div className="mt-4 p-4 bg-green-100 border border-green-300 rounded-md">
                        ...
                        <div className='gap-[5px]'>
                            <button
                                className="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-900 mr-4"
                                onClick={() => navigator.clipboard.writeText(`http://localhost:3000/collection/${uuid}`)}
                            >
                                Copy Link to Clipboard
                            </button>
                            <a
                                href={`http://localhost:3000/collection/${uuid}`}
                                className="bg-[#086788] hover:bg-[#5099b2] text-white px-4 py-2 rounded-md t-2 inline-block text-center"
                            >
